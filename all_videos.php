                                        ...
                                        <table class="table convert-data-table table-striped">
                                            ...
                                            <?php
                                                ...
                                                while($row = mysqli_fetch_assoc($result)){
                                                    ...
                                                    echo "<td><a href='app/uploads/video/".$row['v_path']."' target='_blank'><i class='fa fa-file-video-o' aria-hidden='true'></i></a></td>";
                                                    echo "<td>".date('d-m-Y H:i',$row['v_time'])."</td>";
                                                    echo "<td><a href='delete_video.php?v_id=".$row['v_id']."'><i class='fa fa-trash'></i></a></td>";
                                                    echo "</tr>";
                                                }
